...
const FAQ_DATA = [
  { q: "LuTech phù hợp với quy mô trung tâm nào?", a: "LuTech được thiết kế linh hoạt. Dù bạn là một giáo viên dạy kèm nhóm nhỏ, hay chuỗi trung tâm với hàng ngàn học viên, hệ thống đều đáp ứng tốt nhờ khả năng phân quyền và mở rộng linh hoạt." },
  { q: "Hệ thống có cần phần cứng đặc biệt không?", a: "LuTech là nền tảng SaaS hoàn toàn trên nền tảng đám mây. Bạn chỉ cần một chiếc máy tính hoặc máy tính bảng kết nối internet là có thể quản lý mọi hoạt động dạy và học." },
  ...
  { q: "Làm thế nào để giáo viên làm quen với LuTech?", a: "Chúng tôi cung cấp bộ video hướng dẫn chi tiết, tài liệu PDF và buổi đào tạo trực tuyến 1:1 cho đội ngũ giáo viên của bạn. Thông thường, giáo viên chỉ cần 2 giờ để làm chủ hệ thống." },
