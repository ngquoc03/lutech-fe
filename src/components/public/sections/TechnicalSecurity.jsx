      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <p className="text-gray-400 mb-8 leading-relaxed">
            Tại LuTech, chúng tôi hiểu dữ liệu học sinh là tài sản quý giá nhất. Hệ thống được xây dựng trên nền tảng Cloud tiên tiến với các tiêu chuẩn bảo mật khắt khe nhất hiện nay.
          </p>
        ...
        <div className="bg-white/5 p-10 rounded-3xl border border-white/10">
            ...
            <p className="text-gray-400">LuTech cam kết không chia sẻ dữ liệu học viên của bạn cho bên thứ ba dưới mọi hình thức. Bạn là chủ sở hữu duy nhất của dữ liệu.</p>
        </div>
      </div>
    </section>
  );
